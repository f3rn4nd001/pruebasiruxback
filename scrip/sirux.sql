...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2024 a las 22:31:13
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `stpInsertarBitCorreo` (`uuid2uuiecodCorreo` VARCHAR(50), `tCorreov` VARCHAR(100), `tContraseñav` VARCHAR(250))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stpInsertarCatUsuario` (`uuid2ecodUsuario` VARCHAR(50), `tNombrev` VARCHAR(40), `tApellidov` VARCHAR(40), `tCRUPv` VARCHAR(25), `tRFCv` VARCHAR(30), `tSexov` VARCHAR(20), `nTelefonov` VARCHAR(20), `tNotasv` VARCHAR(250), `nEdadv` INT(8), `ecodEstatusv` VARCHAR(50), `loginEcodUsuarios` VARCHAR(50), `fhNacimientov` VARCHAR(50), `iUsuariov` LONGTEXT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stpInsertarLogCatUsuario` (`loguuid2` VARCHAR(50), `ecodUsuario` VARCHAR(50), `tNombrev` VARCHAR(40), `tApellidov` VARCHAR(40), `tCRUPv` VARCHAR(25), `tRFCv` VARCHAR(30), `tSexov` VARCHAR(20), `nTelefonov` VARCHAR(20), `tNotasv` VARCHAR(250), `nEdadv` INT(8), `ecodEstatusv` VARCHAR(50), `fhNacimientov` VARCHAR(50), `ecodCreacionv` VARCHAR(50), `fhCreacionv` VARCHAR(50), `ecoEdicionv` VARCHAR(50), `fhEdicionv` VARCHAR(50), `iUsuariov` LONGTEXT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stpInsertarLogin` (`ecodCorreov` VARCHAR(150), `tokenv` VARCHAR(500), `ipv` VARCHAR(30))   BEGIN
declare existe int;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stpInsertarRelUsuarioCorreo` (`uuid2uuiecodRelUsuarioCorreov` VARCHAR(50), `uuid2uuiecodCorreov` VARCHAR(50), `uuid2ecodUsuariov` VARCHAR(50))   BEGIN
...
--
-- Estructura de tabla para la tabla `bitcorreo`
--

CREATE TABLE `bitcorreo` (
  `ecodCorreo` varchar(50) NOT NULL,
  `tCorreo` varchar(100) NOT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `tpassword` varchar(500) NOT NULL,
  `tToken` varchar(500) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `bitcorreo`
--

INSERT INTO `bitcorreo` (`ecodCorreo`, `tCorreo`, `email_verified_at`, `tpassword`, `tToken`, `remember_token`, `created_at`, `updated_at`, `tIp`) VALUES
('8a69b1f0-3ea5-4422-b9e7-87e238dc71e0', 'admin@gmail.com', NULL, 'delunoalcero09', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..l5ZxT-frdSDboy1y3OnmgEuX7S3RgJqKURDA4AXMzFw', NULL, NULL, NULL, '127.0.0.1');
...
CREATE TABLE `catcontroller` (
  `ecodControler` varchar(50) NOT NULL,
...
INSERT INTO `catcontroller` (`ecodControler`, `tNombre`, `tUrl`, `ecodEstatus`, `ecodCreacion`, `fhCreacion`, `ecodEdicion`, `fhEdicion`) VALUES
('20b70474-70ee-483e-8d6c-2fa5f280d404', 'Editar usuario', '/catalogo/usuario/registrar', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2024-09-24 06:08:49', NULL, NULL),
('2cedd864-391d-4d1f-8f7a-c7f3fc5a39ab', 'Eliminar usuario', '/catalogo/usuario/eliminar', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2024-09-24 06:08:49', NULL, NULL);
...
('aae1c339-1b68-40f2-a47f-2f9e17ef7fd3', 'Agotado'),
('fa6cc9a2-f221-4e27-b575-1fac2698d27a', 'Eliminado');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `caticono`
--

CREATE TABLE `caticono` (
  `ecodIcono` varchar(50) NOT NULL,
  `tIcono` varchar(50) NOT NULL,
  `tNombre` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `caticono`
--

INSERT INTO `caticono` (`ecodIcono`, `tIcono`, `tNombre`) VALUES
('0054fd74-795e-41c4-adff-7641612492b3', 'fa fa-compass fa-2x', 'Compass'),
('031afad4-e623-4f90-9e74-87ba55166475', 'fa fa-hashtag', 'Hashtag'),
('0512148c-3758-4405-b1f4-a1bc2b8b4f63', 'fa fa-anchor fa-2x', 'Anchor'),
('066fe4b0-46c6-488c-82db-59cb99e26992', 'fa fa-asterisk fa-2x', 'Asterisk'),
('0716f257-66a2-41de-9373-a3a95d17e70f', 'fa fa-book fa-2x', 'Book'),
('084dc80f-282e-4818-a563-084f8c1573db', 'fa fa-bathtub fa-2x', 'Bathtub'),
('08f2d4de-3c30-44b0-81bc-4daa9a930221', 'fa fa-commenting fa-2x', 'Commenting'),
('0a3bba28-5089-4641-9557-3e18bb3b0ea7', 'fa fa-eye-slash fa-2x', 'Eye slash'),
('0a3ddb28-60bf-4471-a04e-73f94b9b933b', 'fa fa-check-square-o fa-2x', 'Check square'),
('0c590371-57ee-4143-8832-7b7bdc160e2c', 'fa fa-file-zip-o fa-2x', 'File zip'),
('0d725b00-9b45-4283-8641-fbed968e332f', 'fa fa-address-card-o fa-2x', 'Address card o'),
('0d8eb13a-686c-44c3-8a30-b8496b582df8', 'fa fa-assistive-listening-systems fa-2x', 'assistive listening systems'),
('0dad7165-0403-4aeb-81bc-f093ec66bd06', 'fa fa-asl-interpreting fa-2x', 'Asl interpreting'),
('0dedf220-d077-4808-8560-e0f5fa533af0', 'fa fa-cloud-upload fa-2x', 'Cloud upload'),
('0e95307c-433c-48ab-b692-70f89841c270', 'fa fa-shopping-cart fa-2x', 'Shopping cart'),
('0fbb708a-7469-47d7-a3c6-0e4685e9aca0', 'fa fa-eye fa-2x', 'Eye'),
('10867fed-d3db-4382-9294-bd2f95744005', 'fa fa-deaf fa-2x', 'Deaf'),
('112652dd-1246-4d1e-9d7c-5e6725048e81', 'fa fa-file-photo-o fa-2x', 'File photo'),
('11c9663c-146d-4d6b-ac8a-7e353001ef27', 'fa fa-bullhorn fa-2x', 'Bullhorn'),
('120f9498-7a16-4bc8-930f-922cc1d7d6e7', 'fa fa-globe fa-2x', 'Globe'),
('122358cb-9386-41cd-8d35-676447d8f1ab', 'fa fa-cab fa-2x', 'Cab'),
('12b17389-ac41-4d39-b25b-0bf118907b8b', 'fa fa-commenting-o', 'Commenting'),
('12ee1a1b-0c11-4e98-b0e1-cf57d6320d54', 'fa fa-bomb fa-2x', 'Bomb'),
('146c45f4-f06f-4720-bf4a-f41f4fd79c29', 'fa fa-child', 'Child'),
('14733c13-ddd1-4fdc-982a-09878f46b378', 'fa fa-camera-retro fa-2x', 'Camera retro'),
('1526e234-555e-4f2a-9917-fcfb4856ad04', 'fa fa-exchange fa-2x', 'Exchange'),
('1543185f-3e12-4db1-b471-9153e91c99bf', 'fa fa-cloud', 'Cloud'),
('156cfcbb-23f4-481c-a880-e41c15abf718', 'fa fa-bar-chart-o fa-2x', 'Bar chart'),
('16034d6d-9117-4668-b97c-efbc0eb98543', 'fa fa-dot-circle-o', 'Dot Circle'),
('17129808-e536-4046-8f20-48a22c3d9151', 'fa fa-file-audio-o fa-2x', 'File audio'),
('18081635-0d7c-4e25-9326-59da5dc58be7', 'fa fa-arrows-v fa-2x', 'arrows'),
('1e93eaba-ad39-44c7-bf2d-df905a2cf5bd', 'fa fa-circle', 'Circle'),
('1f57614b-65e3-4cd4-92af-82b178d56675', 'fa fa-hourglass-1', 'Hourglass 1'),
('1f9dff09-a4ff-4cc9-b052-64ef4ae493cd', 'fa fa-arrows-h fa-2x', 'arrows'),
('1fd1fac6-d4e5-4ed3-8c3e-5e5a3acf77c6', 'fa fa-car fa-2x', 'Car'),
('1ff1bbae-d3fb-4fd6-b784-808d88ef55fc', 'fa fa-exclamation fa-2x', 'Exclamation'),
('208127c2-4186-4dce-9bcc-fde9ecabf1ac', 'fa fa-fighter-jet fa-2x', 'Fighter jet'),
('219bfa25-9f14-4b68-9915-b86e8a156dd2', 'fa fa-code', 'Code'),
('23032645-5cf7-4e75-8574-adeafd782e2e', 'fa fa-fire fa-2x', 'Fire'),
('2309ff36-dfab-4489-93b3-d0b44a329a84', 'fa fa-cart-arrow-down fa-2x', 'Cart arrow down'),
('2380653c-c024-487d-a0be-b743f1f8de42', 'fa fa-credit-card-alt', 'Credit card alt'),
('24969bd9-d2f6-4a73-aa65-7ef2e2e8346f', 'fa fa-caret-square-o-up fa-2x', 'Caret square up'),
('250e9d4b-c997-4a70-b4fe-7bf78f33648d', 'fa fa-calendar-o fa-2x', 'Calendar'),
('26053421-d1af-427a-a76a-157af198d69a', 'fa fa-gear fa-2x', 'Gear'),
('2660ce7b-ec45-4c35-af25-260fe78c3a25', 'fa fa-edit fa-2x', 'Edit'),
('26685809-145c-46b5-9092-b105494b40cc', 'fa fa-caret-square-o-left fa-2x', 'Caret square left'),
('26fd85a5-863c-4d6a-a812-3ba0a4e6711f', 'fa fa-group fa-2x', 'Group'),
('28c83f7e-0a08-447c-b715-085a526be2ba', 'fa fa-camera fa-2x', 'Camera'),
('2a8577c6-bfbb-48e7-a510-ea2ce0224960', 'fa fa-close', 'Close'),
('2b61ee57-0937-4f63-99f4-bfa6434561af', 'fa fa-cog', 'Cog'),
('2cfe4913-15f9-4cad-81eb-365b721bfe42', 'fa fa-bars fa-2x', 'Bars'),
('2fec8a58-c460-4795-86ee-8cfe82228d8f', 'fa fa-hourglass-2', 'Hourglass 2'),
('3268dcfc-bc8f-4fba-ad01-fa713ade3593', 'fa fa-folder-open-o fa-2x', 'Folder open'),
('33badf1b-090c-433d-bdc9-ad0c8e76fb2d', 'fa fa-drivers-license fa-2x', 'Drivers license'),
('38163aac-d391-4b74-afd2-e1098adc9020', 'fa fa-hourglass-end', 'Hourglass end'),
('38289d8f-0f3b-4298-b84e-5874312e89c8', 'fa fa-circle-o-notch', 'Circle notch'),
('3b241c24-28f2-4470-b7dd-49f052304525', 'fa fa-balance-scale fa-2x', 'Balance scale'),
('3e10ce86-ff55-4b6a-a1de-c87445e8df94', 'fa fa-gavel fa-2x', 'Gavel'),
('40886693-355a-4262-b4b2-17ac5fe972a5', 'fa fa-fire-extinguisher fa-2x', 'File extinguisher'),
('40b993c3-c4d6-4338-bb98-537a6b4708be', 'fa fa-address-book fa-2x', 'Address book'),
('40cb797b-f2dd-4476-9d95-eb29e2226f42', 'fa fa-hard-of-hearing fa-2x', 'Hard of hearing'),
('41a4ab25-a617-4120-9d78-12bb87438099', 'fa fa-flask fa-2x', 'Flask'),
('41e75ccf-e2f2-442e-b83d-271fc16c0ccb', 'fa fa-flag-checkered fa-2x', 'Flag checkered'),
('429dde8c-12b1-4bb6-ab78-7175b04ba09d', 'fa fa-file-picture-o fa-2x', 'File picture'),
('42cbf8ce-555b-4093-a482-500eecd114aa', 'fa fa-calculator fa-2x', 'Calculator'),
('42d6e5e0-09de-47eb-91a5-ae37c91cee9b', 'fa fa-gift fa-2x', 'Gift'),
('4316c8f0-af89-472d-823a-9d2d54bddf28', 'fa fa-bed fa-2x', 'Bed'),
('43aa914d-b9ee-42fd-8f8f-611f8c1fdc76', 'fa fa-beer fa-2x', 'Beer'),
('43f64517-bd5a-4087-8ebf-d7c85b6cf1f0', 'fa fa-bus fa-2x', 'Bus'),
('4441f162-1f9c-42ba-900b-2eccca496048', 'fa fa-heart-o fa-2x', 'Heart o'),
('4b1cb0db-3f6b-4b07-a431-6042960e31da', 'fa fa-external-link fa-2x', 'External link'),
('4ec94002-6e83-467d-82b7-696b41e84b7f', 'fa fa-bank fa-2x', 'Bank'),
('4eeb4c89-6696-4c87-b47b-8dbb7816c900', 'fa fa-diamond', 'Diamond'),
('4fd15146-d81b-41f2-853f-be8e4b269b10', 'fa fa-hdd-o fa-2x', 'Hdd'),
('5400a07d-a827-48d9-93bf-632d96f2016b', 'fa fa-bookmark fa-2x', 'Bookmark'),
('547bb7be-6224-4883-b68b-fc431adb0059', 'fa fa-female fa-2x', 'Famela'),
('559fdfa6-bf4c-4070-8337-5219ece8e4f7', 'fa fa-circle-thin', 'Circle thin'),
('56df2b38-696e-47fa-933b-e6f33efaf112', 'fa fa-heartbeat fa-2x', 'Heartbeat'),
('58ceca77-75ef-4547-a9b5-bde19620a100', 'fa fa-bookmark-o fa-2x', 'Bookmark'),
('58de2cb6-26fc-4421-9aab-f68f03117ca1', 'fa fa-exclamation-triangle fa-2x', 'Exclamation triangle'),
('59d2b69c-8d68-4374-a754-c486996f5cc7', 'fa fa-flash fa-2x', 'Flash'),
('5a6505eb-6d36-4759-82b4-6108f7f2d52e', 'fa fa-download fa-2x', 'Download'),
('5c2b1961-cab1-450e-81d3-418a3592eae0', 'fa fa-arrows fa-2x', 'arrows'),
('5c85a57d-a20f-4b6d-bf1c-9f8558dd3ba4', 'fa fa-home fa-2x', 'Home'),
('5e4bd352-de28-4e92-b1d4-b43937bbb611', 'fa fa-building fa-2x', 'Building'),
('5ea962c8-0105-4d52-ab27-b6486abcf1e9', 'fa fa-comment-o', 'Comment'),
('61075f47-1b00-43dc-9401-ed219801cb55', 'fa fa-graduation-cap fa-2x', 'Graduation cap'),
('620e2706-930b-499a-982d-3169c0f14d88', 'fa fa-address-card fa-2x', 'Address card'),
('632027c0-d206-4ca7-9651-4c5749d63562', 'fa fa-bar-chart fa-2x', 'Bar chart'),
('65c91fa5-a8e4-42ae-9f04-a6877f4ad078', 'fa fa-battery-empty fa-2x', 'Battery empty'),
('679a344d-ee01-4326-a684-f71f9c42df5f', 'fa fa-automobile fa-2x', 'Automobile'),
('67e4d56f-311e-4f8e-b73d-9392895259c4', 'fa fa-external-link-square fa-2x', 'External link square'),
('6a615d03-5e6e-405b-9dba-e25addae41f2', 'fa fa-area-chart fa-2x', 'Area chart	'),
('6e1456d4-f99e-4c17-ad39-90e3ea612f15', 'fa fa-upload fa-2x', 'Upload'),
('707eb0cc-fbc4-4075-8be9-e1469f467efe', 'fa fa-hourglass-half', 'Hourglass half'),
('70f1aa61-3b7c-4f7f-b841-bbc65226d239', 'fa fa-flag-o fa-2x', 'Flag'),
('713136ec-c53d-4b4a-a747-d07df263a4ce', 'fa fa-calendar-check-o fa-2x', 'Calendar check'),
('71ea2932-3ba0-4b5e-bfea-192beafb5043', 'fa fa-gears fa-2x', 'Gears'),
('71f83e92-a3de-4829-a0b6-949033998361', 'fa fa-ellipsis-h fa-2x', 'Ellipsis'),
('749d89e9-1f16-433a-b507-e3dcbb74be51', 'fa fa-fax fa-2x', 'Fax'),
('74cb0b82-c7bc-4443-96ec-9474a8fe5c13', 'fa fa-calendar-minus-o fa-2x', 'Calendar minus'),
('75d0f2ec-8df0-42f0-b2c7-01fd16ef383d', 'fa fa-calendar fa-2x', 'Calendar'),
('790f3b66-8476-4d2b-88e7-0e218a65393b', 'fa fa-file-image-o fa-2x', 'File image'),
('79c13db5-f0b1-4bfe-a864-1a4684b905ec', 'fa fa-comment', 'Comment'),
('7b7f825d-cdad-47e7-abc5-73ff88c30a2e', 'fa fa-database', 'Database'),
('7ba66170-5cbb-4d7e-a5f2-d95081c0e291', 'fa fa-calendar-plus-o fa-2x', 'Calendar plus '),
('82420485-13d6-47bb-9d70-d602e1cf77f1', 'fa fa-bullseye fa-2x', 'Bullseye'),
('845d7639-2448-42cf-a2c2-2e9549ca3cc1', 'fa fa-hourglass-3', 'Hourglass 3'),
('8610d42e-4dbc-41e2-ba6c-58f76628ef6e', 'fa fa-folder-open fa-2x', 'Folder open'),
('86502e2d-3662-4bcb-a8dd-d6c5a1cea1aa', 'fa fa-exclamation-circle fa-2x', 'Exclamation circle'),
('868ff641-1156-44c9-8def-105c0ec0472f', 'fa fa-crop', 'Crop'),
('8752ddcc-5593-47ad-b959-2111911191f4', 'fa fa-calendar-times-o fa-2x', 'Calendar times'),
('87d64593-9078-491b-8f7e-6946a5467260', 'fa fa-deafness', 'Deafness'),
('887f3550-d237-45bf-ad4d-d98165f8980b', 'fa fa-flag fa-2x', 'Flag'),
('88bdcbb3-cbe6-4f29-8d3b-7495e7e0e4a3', 'fa fa-envelope-o fa-2x', 'Envelope'),
('8a107c43-62f8-48e7-82c8-a9dcfb94b58f', 'fa fa-cloud-download', 'Cloud download'),
('8b485445-3af7-4183-a20c-19c79f1544ae', 'fa fa-comments', 'Comments'),
('8bc4933c-8cf9-4e65-94c6-bbe8c1d197aa', 'fa fa-clone', 'Clone'),
('8c0fe9b2-43d0-4cd8-8dbf-3f172d7e5ca6', 'fa fa-bug fa-2x', 'Bug'),
('8f14d888-c6fd-47ea-b2b0-36273bfa212b', 'fa fa-adjust fa-2x', 'Adjust'),
('939c1343-0a7d-49fb-ab2b-7d5fdd9a82e5', 'fa fa-bolt fa-2x', 'Bolt'),
('96149a92-0aa3-4a78-82c7-cd89acc1e06c', 'fa fa-barcode fa-2x', 'Barcode'),
('97a54636-78eb-40e4-8c70-8c6ce2ae1efc', 'fa fa-eraser fa-2x', 'Eraser'),
('98698b57-b2ff-40e0-8742-7f3ee4fcb6cf', 'fa fa-file-pdf-o fa-2x', 'File pdf'),
('9b302993-69d8-4db5-a110-f8baabaab737', 'fa fa-handshake-o', 'Handshake o'),
('9eee6572-d932-440f-a1c6-aaba8b57ac57', 'fa fa-american-sign-language-interpreting fa-2x', 'American language interpreting'),
('9ff079f0-ac80-46d4-8f0f-ab2ed01c7e26', 'fa fa-copyright', 'Copyright'),
('a1571554-8952-4f9d-8e40-404dac97e55f', 'fa fa-file-powerpoint-o fa-2x', 'File powerpoint'),
('a20ef0fa-e816-433f-8167-e7277f11359d', 'fa fa-drivers-license-o fa-2x', 'Drivers license'),
('a2f952b3-bee6-4a37-a142-1414b5395c2a', 'fa fa-cubes', 'Cubes'),
('a2fc1312-b83c-43cb-b81a-325d4c2bf187', 'fa fa-heart fa-2x', 'Heart'),
('a6a05e21-d9d1-4c88-9557-1a696a629655', 'fa fa-headphones fa-2x', 'Headphones'),
('a7d53a05-1e99-4532-b61b-7b74ae8ea3e1', 'fa fa-battery-1 fa-2x', 'Battery'),
('a8dfd448-82d5-4b46-b8f6-8df6f65f0f2e', 'fa fa-file-sound-o fa-2x', 'File sound'),
('a8e84bb0-2ed7-4bc6-bf51-c1278c0e1a1f', 'fa fa-battery-3 fa-2x', 'Battery'),
('a956effd-f379-4939-9120-7c1d4678df3e', 'fa fa-cogs', 'Cogs'),
('a9fcf64b-356f-4211-8b03-ccf2608939e6', 'fa fa-coffee', 'Coffee'),
('aae9b150-7bbf-47d9-aebc-1f911e7beaa2', 'fa fa-audio-description fa-2x', 'Audio description'),
('abbfed7f-7b2c-42c8-9704-391f6341d274', 'fa fa-bicycle fa-2x', 'Bicycle'),
('ac2ae295-3e10-47a8-bdeb-49ed65150b2f', 'fa fa-bell-o fa-2x', 'Bell'),
('ad998718-65bb-4444-ad33-4dc2ba76a419', 'fa fa-address-book-o fa-2x', 'Address book o'),
('ae651125-b70c-45ab-bf2e-3eb00cd4fec0', 'fa fa-bell-slash fa-2x', 'Bell slash'),
('aea9fbed-0abd-4638-af0b-724393d99d24', 'fa fa-comments-o', 'Comments'),
('b323fb93-b5a6-4825-9a02-2a41ed2c86cf', 'fa fa-ban fa-2x', 'Ban'),
('b5055cd6-a694-411e-b9bd-be5f276038d2', 'fa fa-file-code-o fa-2x', 'File code'),
('b513527d-5a2c-4dcd-a86e-1e0a860e8a48', 'fa fa-cart-plus fa-2x', 'Cart plus'),
('b99c6ca6-85ed-4d8b-abaa-878b8d4fc526', 'fa fa-cube', 'Cube'),
('ba19e0cd-1525-4e93-97a3-ebc0ecee3fbc', 'fa fa-crosshairs', 'Crosshairs'),
('ba84a1d3-7051-460d-9afb-cf8b370cfa0d', 'fa fa-desktop', 'Desktop'),
('bd23bd6c-86a4-45fa-bc41-43e8f7d8c6bf', 'fa fa-clock-o', 'Clock'),
('bd5e59df-da78-4008-8ed4-e830c4d3d3a3', 'fa fa-creative-commons', 'Creative commons'),
('bdc15c96-90cb-458e-87c3-0e7dbf26d34c', 'fa fa-envelope-open fa-2x', 'Envelope open'),
('be132240-c155-4b5e-8127-161b6509a345', 'fa fa-building-o fa-2x', 'Building'),
('bedf8e45-6e4b-4064-83bc-e9ccdc77d1b7', 'fa fa-genderless fa-2x', 'Genderless'),
('c22d21e9-66ce-4908-9ef3-ddf6cfd830ec', 'fa fa-archive fa-2x', 'Archive'),
('c2f0ff2c-f665-48f4-b919-ade78759d45f', 'fa fa-bath fa-2x', 'Bath'),
('c7d3c7ca-ac50-489e-8e4c-4b2be21556d3', 'fa fa-envelope fa-2x', 'Envelope'),
('c954aaf2-9836-48ad-915d-e1a051a4676b', 'fa fa-gamepad fa-2x', 'Gamepad'),
('c984d7f1-1372-418a-b4a1-2321aaf2912d', 'fa fa-binoculars fa-2x', 'Binoculars'),
('ceffe364-fa0c-464a-b3dd-32251cf49a3a', 'fa fa-envelope-open-o fa-2x', 'Envelope open'),
('cfe6e6c4-04ab-4f99-bd86-8d58ebee5ed5', 'fa fa-eyedropper fa-2x', 'Eyedropper'),
('d0e4b9c5-d89d-4161-b01c-6bd1fd2b771e', 'fa fa-history fa-2x', 'History'),
('d13895ab-ed0a-4f3a-8188-ff98ac7c3929', 'fa fa-file-word-o fa-2x', 'File word'),
('d1b3f470-bb1c-413d-a889-759d6d70b7d7', 'fa fa-shopping-bag fa-2x', 'Shopping bag'),
('d1b70bdf-c820-4cbc-8947-e00085993ed3', 'fa fa-hourglass-o', 'Hourglass o'),
('d3ac2a99-376b-485c-b16c-ce674baa467d', 'fa fa-folder-o fa-2x', 'Folder'),
('d4cc6f5e-6189-41d7-adad-15ac9c676726', 'fa fa-code-fork', 'Code fork'),
('d5c530c1-3d82-4a06-8bb0-fe2b727d0f6c', 'fa fa-film fa-2x', 'Film'),
('d7128799-56f1-4b65-941d-7a2cba821e31', 'fa fa-battery-2 fa-2x', 'Battery'),
('d76f641e-f6bd-4f44-9a92-dff2bcb68b43', 'fa fa-file-excel-o fa-2x', 'File excel'),
('da320cd6-4426-4a7b-81d0-7339fd095026', 'fa fa-credit-card', 'Credit card'),
('db1d5baf-3437-4c58-8e94-79c547631b6b', 'fa fa-blind fa-2x', 'Blind'),
('db9135b2-5344-4435-a4be-654a7f5221ce', 'fa fa-check-circle', 'Check circle'),
('dfa1c199-919e-423f-97f7-427130254b56', 'fa fa-dashboard', 'Dashboard'),
('e068dc69-9d6d-4800-a941-63da7e7f8334', 'fa fa-circle-o', 'Cicle'),
('e269d2a8-ff9d-4986-b30b-8bcadd8cfac3', 'fa fa-file-video-o fa-2x', 'File video'),
('e3479e15-4e81-4a65-9870-78b4a5fbed9a', 'fa fa-ellipsis-v fa-2x', 'Ellipsis'),
('e3510bf6-3a86-4ec1-802c-99a2d29b1989', 'fa fa-file-archive-o fa-2x', 'File archive'),
('e39d4a23-e7c6-4b62-b217-17054261e9b4', 'fa fa-at fa-2x', 'At'),
('e49cb6fa-a4cb-4e60-ba2f-6934d0a87732', 'fa fa-frown-o fa-2x', 'Frown'),
('e8c856b3-7b04-412d-b797-57fd5a97d5d6', 'fa fa-check-square', 'Check square'),
('e9e56e8b-7d6c-4f9b-906a-3e94e0defa1f', 'fa fa-birthday-cake fa-2x', 'Birthday cake'),
('ea94199c-cb69-423c-abf0-011845058a03', 'fa fa-battery-0 fa-2x', 'Battery'),
('ec2c5541-f362-4b7b-a1bf-999ab102c748', 'fa fa-hourglass fa-2x', 'Hourglass'),
('ec8b3036-03f0-4873-b2c8-fb75dcbf8150', 'fa fa-briefcase fa-2x', 'Briefcase'),
('ee36b7a2-f88c-4937-99b2-c60b339c4fd1', 'fa fa-chec', 'Check'),
('ef403d05-bc1b-4c67-ad94-edb2646cb662', 'fa fa-certificate fa-2x', 'Certificate'),
('ef587dee-f918-438e-af79-ea6b2c114d2a', 'fa fa-hourglass-start', 'Hourglass start'),
('f0f851bf-acda-4598-94a5-5b1fdf085175', 'fa fa-hotel fa-2x', 'Hotel'),
('f186ebda-c4e5-4ca9-b931-8b65c906d841', 'fa fa-bell fa-2x', 'Bell'),
('f2559a39-6adc-4bab-9b05-39a14533d3a9', 'fa fa-cutlery', 'Cutlery'),
('f2b394f3-2cce-49ae-89b6-18947ac84862', 'fa fa-caret-square-o-right fa-2x', 'Caretsquare right'),
('f3051a83-9111-483d-90e4-44cdb8f0ee10', 'fa fa-futbol-o fa-2x', 'Futbol'),
('f3eb3a9e-ad57-446e-8ddf-115e07563406', 'fa fa-caret-square-o-down fa-2x', 'Caret square down'),
('f6a6adcb-1fb0-445a-879d-65eb03aef86d', 'fa fa-folder fa-2x', 'Folder'),
('f75157aa-7d4e-44f2-86d8-bc0abcdf4c0b', 'fa fa-file-movie-o fa-2x', 'File movie'),
('f760d3a2-8848-4816-b019-b3a304112533', 'fa fa-glass fa-2x', 'Glass'),
('f7a0d0f7-cca8-4964-b3a5-b150d323cd03', 'fa fa-check-circle-o', 'Check circle'),
('fa647686-7182-4aa9-9ce3-1f38ca6229ad', 'fa fa-battery-4 fa-2x', 'Battery'),
('fb6a58cc-ed87-4025-b690-ab85a835d7b7', 'fa fa-braille fa-2x', 'braille'),
('fba79907-50a0-4bc9-a376-90a3298c4f0e', 'fa fa-bell-slash-o fa-2x', 'Bell slash'),
('fcc48aa8-50a7-4f44-8d39-10631ea9876b', 'fa fa-filter fa-2x', 'Filter'),
('fd7eeee6-7cae-4efc-893c-5bda74214f00', 'fa fa-envelope-square fa-2x', 'Envelope square'),
('shopping-basket', 'fa fa-shopping-basket fa-2x', 'Shopping basket');
...
CREATE TABLE `catmenu` (
  `ecodMenu` varchar(50) NOT NULL,
  `tNombre` varchar(25) NOT NULL,
  `ecodIconos` varchar(50) DEFAULT NULL,
  `ecodCreacion` varchar(50) NOT NULL,
  `fhCreacion` datetime NOT NULL,
  `ecodEdicion` varchar(50) DEFAULT NULL,
  `fhEdicion` datetime DEFAULT NULL,
...
INSERT INTO `catmenu` (`ecodMenu`, `tNombre`, `ecodIconos`, `ecodCreacion`, `fhCreacion`, `ecodEdicion`, `fhEdicion`, `ecodEstatus`) VALUES
('9bd00aa8-7232-44dc-bcb7-f209d503e391', 'Catalogo', '8610d42e-4dbc-41e2-ba6c-58f76628ef6e', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2024-09-24 06:08:49', NULL, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c');
...
CREATE TABLE `catpermisos` (
  `ecodPermisos` varchar(50) NOT NULL,
  `tNombre` varchar(10) NOT NULL,
  `tNombreCorto` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('2660376e-dbf9-42v1-b12r-l2254p0t5d4c', 'Leer', 'R'),
('6180d3bb-04ae-4e92-858c-184c305561e5', 'Clear', 'C');
...
CREATE TABLE `catsubmenu` (
  `ecodSubmenu` varchar(50) NOT NULL,
...
('710b0887-8372-4148-bf17-f169d762fcf3', 'Usuarios', '/catalogo/usuario', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2024-09-24 06:08:49', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL);
...
CREATE TABLE `cattipousuario` (
  `ecodTipoUsuario` varchar(50) NOT NULL,
  `tNombre` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `cattipousuario` (`ecodTipoUsuario`, `tNombre`) VALUES
('b55aa80a-8c1f-4e91-8366-07dd44446b5c', 'Cliente'),
('d2438dce-4bb9-402f-801b-9dc371d08e6e', 'Empleados'),
('fa6cc9a2-f221-4e27-b575-1fac2698d27a', 'Administrador');
...
CREATE TABLE `catusuarios` (
  ...
  `tApellido` varchar(40) NOT NULL,
  `tCRUP` varchar(25) DEFAULT NULL,
  `tRFC` varchar(30) DEFAULT NULL,
  `nEdad` int(4) DEFAULT NULL,
  `tSexo` varchar(20) DEFAULT NULL,
  `nTelefono` double DEFAULT NULL,
  `tNotas` varchar(250) DEFAULT NULL,
  `ecodEstatus` varchar(50) NOT NULL,
  `ecodTipoUsuario` varchar(50) DEFAULT NULL,
  `fhCreacion` datetime NOT NULL,
  `ecodCreacion` varchar(50) NOT NULL,
  `ecodEdicion` varchar(50) DEFAULT NULL,
  `fhEdicion` datetime DEFAULT NULL,
  `fhNacimiento` date DEFAULT NULL,
  `iUsuario` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `catusuarios` (`ecodUsuario`, `tNombre`, `tApellido`, `tCRUP`, `tRFC`, `nEdad`, `tSexo`, `nTelefono`, `tNotas`, `ecodEstatus`, `ecodTipoUsuario`, `fhCreacion`, `ecodCreacion`, `ecodEdicion`, `fhEdicion`, `fhNacimiento`, `iUsuario`) VALUES
('2660376e-dbf8-44c1-b69f-b2554e3e5d4c', 'carlos', 'ventura', NULL, NULL, NULL, NULL, NULL, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-09-24 13:51:55', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `logcatusuarios`
--

CREATE TABLE `logcatusuarios` (
  `ecodLogUsuario` varchar(50) NOT NULL,
  `ecodUsuario` varchar(50) NOT NULL,
  `tNombre` varchar(40) NOT NULL,
  `tApellido` varchar(40) NOT NULL,
  `tCRUP` varchar(25) DEFAULT NULL,
  ...
  `fhNacimiento` date DEFAULT NULL,
  `iUsuario` longtext DEFAULT NULL,
  `tMotivoEliminacon` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `logcatusuarios`
--

INSERT INTO `logcatusuarios` (`ecodLogUsuario`, `ecodUsuario`, `tNombre`, `tApellido`, `tCRUP`, `tRFC`, `nEdad`, `tSexo`, `nTelefono`, `tNotas`, `ecodEstatus`, `fhCreacion`, `ecodCreacion`, `ecodEdicion`, `fhEdicion`, `fhNacimiento`, `iUsuario`, `tMotivoEliminacon`) VALUES
('5ed0a11e-8ff2-4db5-83b8-6afcaac69876', '49a14067-eaad-4e34-94e6-67b122992aca', 'dawd', 'dawdwa', NULL, NULL, NULL, NULL, NULL, NULL, 'fa6cc9a2-f221-4e27-b575-1fac2698d27a', '2024-09-24 14:14:19', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2024-09-24 14:14:37', NULL, NULL, 'dawdwadwa'),
('98418c68-49c5-45dc-8cba-6b00f239fc32', 'd6860734-7f2c-489a-b573-d5021fed4198', 'adwd', 'dawdwa', NULL, NULL, NULL, NULL, NULL, NULL, 'fa6cc9a2-f221-4e27-b575-1fac2698d27a', '2024-09-24 14:12:59', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '2024-09-24 14:13:19', NULL, NULL, 'dwadawdwa');
...
CREATE TABLE `relusuariocorreo` (
  `ecodRelUsuarioCorreo` varchar(50) NOT NULL,
  `ecodCorreo` varchar(50) NOT NULL,
  `ecodUsuario` varchar(50) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `relusuariocorreo` (`ecodRelUsuarioCorreo`, `ecodCorreo`, `ecodUsuario`, `created_at`, `updated_at`) VALUES
('01ae3cd3-144c-46a3-99aa-bb9174761b37', '8a69b1f0-3ea5-4422-b9e7-87e238dc71e0', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL);
...
CREATE TABLE `relusuariomenusubmenucontroller` (
  `ecodRelusRarioMenuSubmenuController` varchar(50) NOT NULL,
  `ecodUsuario` varchar(50) NOT NULL,
  `ecodMenu` varchar(50) DEFAULT NULL,
  `ecodSubmenu` varchar(50) DEFAULT NULL,
  `ecodController` varchar(50) DEFAULT NULL,
  `tToken` varchar(500) NOT NULL,
  `ecodPermisos` varchar(50) DEFAULT NULL,
...
INSERT INTO `relusuariomenusubmenucontroller` (`ecodRelusRarioMenuSubmenuController`, `ecodUsuario`, `ecodMenu`, `ecodSubmenu`, `ecodController`, `tToken`, `ecodPermisos`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
('', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '9bd00aa8-7232-44dc-bcb7-f209d503e391', '710b0887-8372-4148-bf17-f169d762fcf3', '2cedd864-391d-4d1f-8f7a-c7f3fc5a39ab', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..HQ5WdCG2g6XXWYuACzz55oJ7UW7w-88n3REYn0YBs7Y', NULL, '2024-09-24 09:40:32', NULL, NULL, NULL),
('fed0d2fb-eca2-497e-a796-23e6825e82dc', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '9bd00aa8-7232-44dc-bcb7-f209d503e391', '710b0887-8372-4148-bf17-f169d762fcf3', '20b70474-70ee-483e-8d6c-2fa5f280d404', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..HQ5WdCG2g6XXWYuACzz55oJ7UW7w-88n3REYn0YBs7Y', NULL, '2024-06-09 05:30:16', NULL, NULL, NULL);
...
--
-- Indices de la tabla `bitcorreo`
--
ALTER TABLE `bitcorreo`
...
--
-- Indices de la tabla `caticono`
--
ALTER TABLE `caticono`
  ADD PRIMARY KEY (`ecodIcono`);
...
ALTER TABLE `cattipousuario`
  ADD PRIMARY KEY (`ecodTipoUsuario`);
...
--
-- Indices de la tabla `logcatusuarios`
--
ALTER TABLE `logcatusuarios`
  ADD PRIMARY KEY (`ecodLogUsuario`);
...
ALTER TABLE `relusuariocorreo`
  ADD PRIMARY KEY (`ecodRelUsuarioCorreo`),
